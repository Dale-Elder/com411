# Code to load the titanic data set. #
import csv
    ...
    for record in records:
        ...
        if record[5] != "":
            ...
            if age_group < 18:
                ...
                if survived == 1:
                    elderly_survived += 1
    print(f"Children: {children_survived}/{children}, "
          f"Adults: {adults_survived}/{adults}, "
          f"Elderly: {elderly_survived}/{elderly}")
